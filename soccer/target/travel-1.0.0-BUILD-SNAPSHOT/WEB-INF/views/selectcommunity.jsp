		...
		<div class="col-lg-8">
			<article class="center">
				...
				<section class="mb-5 section1" id="first">
					...
					<img class="heigth" src="<%=request.getContextPath()%>/images/community/${communityfile.com_filename }" alt="..." />
					</c:if>
					...
					<form action="communitymodify" method="post" enctype="multipart/form-data">
						...
						<div class="d-flex marginb">
							<div class="input-group input-group-lg">
								<img id="image" class="heigth" src="<%=request.getContextPath()%>/images/community/${communityfile.com_filename }" alt="..." />
							</div>
						</div>
	...
	commentbtn.addEventListener("click", function() {
		$.ajax({
		    ...
		    data: {
		    	...
		    	com_id : comid.value,
		    	com_text : encodeURIComponent(comment.value)
